...
;
;******************************************************************************
		EXTERN  Motor0Handler
	    EXTERN  UARTIntHandler
		EXTERN	SYSTICKIntHandler
		EXTERN  Timer0Handler
		EXTERN  Timer1Handler
...
__Vectors
        ...
        DCD     Motor0Handler           	; GPIO Port B				17
        ...
        DCD     Timer0Handler	            ; Timer 0 subtimer A		35
        DCD     Timer0Handler	            ; Timer 0 subtimer B		36
        DCD     Timer1Handler	            ; Timer 1 subtimer A		37
        DCD     Timer1Handler          	 	; Timer 1 subtimer B		38
